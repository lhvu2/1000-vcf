...
"""
Input: extracted file, per ALS gene, with all 2500 genomes
Output: create for each genome a separate .csv file in which all meta columns are the same
...
if __name__ == "__main__":
    ...
    root_outdir = parent_path / "vcf/all_genomes"
        ...
        try:
            ...
            for col in df.columns:
                ...
                if not all_equal_target_value:
                    ...
                    print(f"done saving file: {outfile}")
